    ...
    public function __construct()
    {
        $this->tasks = [
            ...
            new class implements TaskContract {
                 ...
                 * @throws InvalidArgumentException If invalid string for event class name or class file exists
            ...
            new class implements TaskContract {
                /**
                 * @param CLICollection|Collection|IO|null $io
                 * @throws RuntimeException If unable to write event class file
                 * @return Collection|IO|null
                 */
                public function __invoke(CLICollection|Collection|IO|null $io = null): Collection|IO|null
                {
            ...
            new class implements TaskContract {
                /**
                 * @param CLICollection|Collection|IO|null $io
                 * @throws RuntimeException If unable to write event handler class file
                 * @return Collection|IO|null
                 */
                public function __invoke(CLICollection|Collection|IO|null $io = null): Collection|IO|null
                {
            ...
            new class implements TaskContract {
                /**
                 * @param CLICollection|Collection|IO|null $io
                 * @throws RuntimeException If unable to register new event to configuration file
